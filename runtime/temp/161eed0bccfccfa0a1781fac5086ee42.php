<?php /*a:2:{s:71:"E:\wwwroot\2025\git\baseShop\application\manage\view\index\welcome.html";i:1765187294;s:64:"E:\wwwroot\2025\git\baseShop\application\manage\view\layout.html";i:1735887385;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                            ...
                            <table class="layui-table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>产品名称</td>
                                        <td>
                                           <?php echo htmlentities($shop_name); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>当前版本</td>
            ...
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header loading-more">
                        ...
                        <a href="<?php echo url('OperationLog/userLog'); ?>">查看更多>></a>
                    </div>
        ...
        <script id="log" type="text/html">
            ...
            <script type="text/javascript">
                layui.use(['laytpl', 'layer'], function() {
                    ...
                    //获取历史登录记录
                    $.get("<?php echo url('manage/administrator/userLogList',array('state'=>1)); ?>", function(data) {
