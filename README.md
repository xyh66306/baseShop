...
#### 更新说明
本次更新继续调整安全以及性能方面，非必要不要直接覆盖更新，本次更新涉及订单、购物车、支付单类型变更。直接升级会导致财务统计、退款申请混乱，请酌情升级。


2024-8-5 v2.9.0
1. 增加公众号下是否开启支付宝支付，增加微信公众号下是否关闭验证码登录，H5下增加免费百度物流轨迹查询
2. 增加企业微信客服支持
3. 增加积分商城：可兑换、可现金+积分
4. 首页布局优化，增加分页展示，避免一次性加载过多
5. 修复首页分享bug以及无法链接跳转到直播间问题
6. 修复自定义链接问题
7. 阿里云配置优化、订单打印修复字符串
8. 优化插件以及售后机制优化
9. 分享后跳转方法优化
10. 修复配送方式bug，优化商品搜索，增加空格识别
11. 修复store_switch 为2 分享的时候的跳转链接
12. 修改底部tabbar细节
13. 修复部分服务器H5海报不显示二维码问题
14. 修复签到数据库兼容性问题
15. 优化微信授权登录获取昵称
16. 命令行下路径问题修复
17. 分销订单导出优化参数为空问题
...
25. 修复拼团相关问题
26. 前端商品列表和详情增加标签显示
27. 优化安全过滤，预防XSS攻击以及SQL注入检测有误问题
28. 优化订单类型
29. 修复单独按钮开关bug
30. 修复可以重复支付问题
31. 修复表单相关问题
