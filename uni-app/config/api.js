...
const methodsToken = [
	...
	"user.getsigninfo",
	"user.pointranking",
	"categories.gettopcat",
	"categories.getchildcat",
	"user.getAddressData",
	"user.getProfit",
	"user.getMyCenData",
	"user.getMonthEarnings",
	"user.getDayEarnings"
];
...
// 获取顶级分类
export const getTopCat = (data, callback) => post('categories.gettopcat', data, callback);

// 获取顶级分类
export const getchildcat = (data, callback) => post('categories.getchildcat', data, callback);

// 快速加入购物车
export const fastadd = (data, callback) => post('cart.batchsetcart', data, callback);


//积分商城 --start
//积分排名
export const getPointRanking = (data, callback) => post('user.pointranking', data, callback);
// 获取商品详情
export const pointDetail = (data, callback) => post('pointmall.detial', data, callback);
//积分商城 --end


//获取地址
export const getAddressData = (data, callback) => post('user.getAddressData', data, callback);

//我的团队展示收益
export const getProfit = (data, callback) => post('user.getProfit', data, callback);

//获取个人中心总收益、余额、待结算
export const getmycendata = (data, callback) => post('user.getMyCenData', data, callback);

//获取我的收益月份数据
export const getMonthEarnings = (data, callback) => post('user.getMonthEarnings', data, callback);
